namespace CSharp.Demo.Inheritance
{
    internal class Program
    {
        ...
        static void Demo2()
        {
            ...
            Console.WriteLine();
            Console.WriteLine($"persoon1.Print() => {persoon1.Print()}");
            Console.WriteLine($"student1.Print() => {student1.Print()}");
            Console.WriteLine($"persoon2.Print() => {persoon2.Print()}");
            Console.WriteLine();
            ...
            Console.WriteLine($"studentAsPerson.Print() => {studentAsPerson.Print()}");
            Console.WriteLine();
            ...
            Console.WriteLine(dummyStudent.Print());
            Console.WriteLine();
            try
            {
                ...
                Console.WriteLine($"notAStudent.Print() => {notAStudent.Print()}");
            }
            ...
            Console.WriteLine($"persoon2.Print() => {persoon2.Print()}");
            Console.WriteLine($"studentAsPerson.Print() => {studentAsPerson.Print()}");
            Console.WriteLine($"dummyStudent.Print() => {dummyStudent.Print()}");
            Console.WriteLine();
            Console.WriteLine("Druk op een toets om naar de volgende stap te gaan");
            Console.ReadKey();
            ...
            if(student2 != null)
            {
                Console.WriteLine($"student2.Print() => {student2.Print()}");
            }
            else
            {
                Console.WriteLine($"{persoon2.Print()} is geen student");
            }
            Console.WriteLine();
            ...
            if(student3 != null)
            {
                Console.WriteLine($"student3.Print() => {student3.Print()}");
            }
            else
            {
                Console.WriteLine($"{persoon1.Print()} is geen student");
            }
            Console.WriteLine();
            Console.WriteLine("Druk op een toets om naar de volgende stap te gaan");
            Console.ReadKey();
            ...
            {
                Console.WriteLine($"stud.Print() => {stud.Print()}");
            }
            else
            {
                Console.WriteLine($"{persoon1.Print()} is geen student");
            ...
            {
                Console.WriteLine($"stud2.Print() => {stud2.Print()}");
            }
            else
            {
                Console.WriteLine($"{persoon2.Print()} is geen student");
